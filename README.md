...
```text
https://<brugernavn>.github.io/ThinkinInUML/
```

## Funktioner

- Lav UML-klassediagrammer direkte i browseren
- Tegn relationer med rette, ortogonale pile
- Importer og eksporter JSON
...
1. Åbn `diagram-editor.html` i browseren.
2. Klik `+ Klasse` for at oprette en klasse.
3. Klik `+ Pil` for at forbinde to klasser.
